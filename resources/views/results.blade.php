...
@section('content')
            ...
            <aside class="sticky top-28"> {{-- fixme - top --}}
                <div class="shadow-md p-5">
                    ...
                    <div class="flex flex-wrap gap-2 mt-5">
                        <a href="/results?tag=tag" class="font-semibold bg-blue-50 text-blue-700 py-1 px-2 text-xs rounded">Frontend</a>
                        <a href="/results?tag=tag" class="font-semibold bg-blue-50 text-blue-700 py-1 px-2 text-xs rounded">Backend</a>
                        <a href="/results?tag=tag" class="font-semibold bg-blue-50 text-blue-700 py-1 px-2 text-xs rounded">PHP</a>
                        <a href="/results?tag=tag" class="font-semibold bg-blue-50 text-blue-700 py-1 px-2 text-xs rounded">ReactJs</a>
                        <a href="/results?tag=tag" class="font-semibold bg-blue-50 text-blue-700 py-1 px-2 text-xs rounded">Azure</a>
                        <a href="/results?tag=tag" class="font-semibold bg-blue-50 text-blue-700 py-1 px-2 text-xs rounded">VueJs</a>
                        <a href="/results?tag=tag" class="font-semibold bg-blue-50 text-blue-700 py-1 px-2 text-xs rounded">Junior</a>
                        <a href="/results?tag=tag" class="font-semibold bg-blue-50 text-blue-700 py-1 px-2 text-xs rounded">Fullstack</a>
                        <a href="/results?tag=tag" class="font-semibold bg-blue-50 text-blue-700 py-1 px-2 text-xs rounded">API</a>
                        <a href="/results?tag=tag" class="font-semibold bg-blue-50 text-blue-700 py-1 px-2 text-xs rounded">Laravel</a>
                    </div>
                        ...
                        @if ($searchResults->count() > 0)
                            @foreach ($searchResults as $searchResult)
                                    <div class="bg-gray-50 mb-3 p-3 hover:bg-blue-50">
                                        <div class="flex">
                                            <h3 class="text-md"><a href="/job/{{ $searchResult->job_id }}" class="text-blue-700 font-semibold">{{ $searchResult->title }}</a></h3>
                                        </div>
                                        <p class="text-sm flex gap-3 font-light mt-1">
                                            <span><i class="fa-solid fa-building text-gray-700"></i> {{ $searchResult->company }}</span>
                                            |
                                            <span><i class="fa-solid fa-map-marker-alt text-gray-700"></i> {{ $searchResult->location }}</span>
                                            |
                                            <span><i class="fa-solid fa-suitcase text-gray-700"></i> {{ $searchResult->type }}</span>
                                        </p>
                                    </div>
                            @endforeach
                        @else
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.tablinks:first').removeClass('border-white border-t-4 border-t-blue-700 border-e border-e-gray-300');
